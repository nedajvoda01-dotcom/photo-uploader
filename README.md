...
6. **ADMIN_PASSWORD** (optional, for MVP/quick setup)
   ...
   - ⚠️ **Security Note:** While convenient for MVP, storing plain passwords in environment variables is less secure than using hashed passwords. For production deployments, consider using `ADMIN_PASSWORD_HASH` instead.
