...
This creates the structure: `/Фото/Фото/` (base dir + subdirectory)
...
- **Example:** `/Фото/Фото`
- **Note:** The "Фото" subdirectory is always present under the base directory

### 2. Region Path
- **Pattern:** `${BASE_PATH}/<REGION>`
- **Example:** `/Фото/Фото/MSK`
...
- **Example:** `/Фото/Фото/MSK/Toyota Camry 1HGBH41JXMN109186/1. Дилер фото/Toyota Camry 1HGBH41JXMN109186`
- **Index:** Always 1
- **Purpose:** Official dealer photos

#### Buyout Photos (8 slots)
- **Pattern:** `${CAR_ROOT}/2. Выкуп фото/<INDEX>. <Марка> <Модель> <VIN>`
- **Example:** `/Фото/Фото/MSK/Toyota Camry 1HGBH41JXMN109186/2. Выкуп фото/3. Toyota Camry 1HGBH41JXMN109186`
- **Index range:** 1-8
- **Purpose:** Photos from vehicle buyout/inspection

#### Dummy Photos (5 slots)
- **Pattern:** `${CAR_ROOT}/3. Муляги фото/<INDEX>. <Марка> <Модель> <VIN>`
- **Example:** `/Фото/Фото/MSK/Toyota Camry 1HGBH41JXMN109186/3. Муляги фото/2. Toyota Camry 1HGBH41JXMN109186`
- **Index range:** 1-5
...
❌ **Bad:**
```typescript
const path = `/Фото/Фото/${region}/${make} ${model} ${vin}`;
```
